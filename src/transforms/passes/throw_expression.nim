...
proc transformThrowExpression*(node: XLangNode, ctx: TransformContext): XLangNode {.gcsafe.}
...
proc transformThrowExpression*(node: XLangNode, ctx: TransformContext): XLangNode =
