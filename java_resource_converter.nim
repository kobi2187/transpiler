...
proc TransformResources(dataPath: string, outputDirectory: string) =
...
proc TransformFeature(featureName: string, featurePath: string, outputDirectory: string) =
...
proc TransformLocalizedFeature(filePath: string, featureName: string, icuLocaleName: string, outputDirectory: string) =
...
proc TransformInvariantFeature(filePath: string, featureName: string, outputDirectory: string) =
      var fileName: string = Path.GetFileName(filePath)
    var outFileName: string = GetFeatureFileName(featureName, fileName)
...
proc LoadLocaleList(dataPath: string, localeListFileName: string = LocaleListFileName): ISet<string> =
    ...
    return result
proc CreateInvariantResourceManifest(invariantResourceDirectory: string, outputDirectory: string) =
