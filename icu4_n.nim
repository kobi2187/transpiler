...
proc AssertTryFormatFor(number: long, locale: UCultureInfo, presentation: NumberPresentation, destination: Span[char]): void =
...
proc Test_PluralFormatUnitTest(culture: string, number: double, pluralPattern: string, pluralType: PluralType, decimalPattern: string, expected: string, assertMessage: string): void =
